...
const UserComponentManagement = () => {
    ...
    let isonForm = useSelector((state) => {
        if (Form.length==0 && state?.adminData?.getComponentAllocation && state?.adminData?.getComponentAllocation.length > 0) {
            let newData = state?.adminData?.getComponentAllocation
            ...
            newData.map((itm) => {
                ...
                if (itm.type == "select") {
                    mergedData.push({
                        label: itm.componentType,
                        value: "",
                        name: itm.componentType,
                        type: itm.type,
                        option: itm.option,
                        required: true,
                        props: {},
    ...
    return <>
        ...
        <div className="m-4 bg-gray-50 border border-gray-700 rounded-2xl max-w-2xl sm:mx-auto sm:w-auto sm:max-w-full p-4">
...
export default UserComponentManagement;
