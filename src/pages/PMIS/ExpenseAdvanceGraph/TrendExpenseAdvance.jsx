...
//   const [extraColumnsState, setExtraColumns] = useState(months);
  ...
  console.log(SeriesData , 'asdfasddhggfsdgdghdghfghjghgsdfgsdfgdsfgsdf')
  ...
  return (
    <div className="bg-transparent border-[1.5px] border-pcol rounded-md h-full p-4">
      ...
      <DoubleBarGraph data={GraphData} seriesData={SeriesData} horizontal={false} title="Trend Expense Advance" />
    </div>
  );
};
