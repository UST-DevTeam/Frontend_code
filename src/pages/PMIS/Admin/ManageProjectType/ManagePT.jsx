...
import ManagePTForm from '../ManageProjectType/ManagePTFrom'
...
const ManagePT = () => {
    ...
    let roleList = useSelector((state) => {
        let interdata = state?.manageCustomers?.Customers_LIST
        return interdata
    })
    ...
    return <>
        <AdvancedTable
            headerButton={<><Button onClick={(e) => {
                ...
                setmodalBody(<ManagePTForm isOpen={modalOpen} setIsOpen={setmodalOpen} resetting={true} formValue={{}} />)
            }}
                name={"Add New"}></Button></>}
            table={table}
