...
const ManageProjectType = () => {
  ...
  console.log(customeruniqueId,projecttypeuniqueId,"customeruniqueId,projecttypeuniqueId")
            ...
            child={
              <EditButton
                ...
                onClick={() => {
                  ...
                  setmodalHead("Edit Project Type");
                  setmodalBody(
                    <>
                      <ManageProjectTypeForm
  ...
  let dbConfigallList = useSelector((state) => {
    console.log(state, "state statejjjj");
  ...
  // if we use this useEffect then api is called according to conditions
  useEffect(() => {
    if (type) {
      dispatch(AdminActions.getManageProjectType(customeruniqueId));
    } else {
  ...
  // if we use this useEffect then both api is called
  // useEffect(() =>{
  //     dispatch(AdminActions.getManageProjectType(customeruniqueId))
  //     dispatch(AdminActions.getCardProjectType(customeruniqueId))
  // },[])
