...
const ManageComplianceTemplateApproverForm = ({ callbackFoResetForm = () => { }, CompleteData ,approverType}) => {
  ...
  let siteuid= CompleteData?.siteuid;
  let milestoneName= CompleteData?.milestoneName;
          ...
          {!isViewOnly() && (
            <>
              ...
              <Button
                classes="w-30"
                name="Upload"
                onClick={() => {setSelectFile(true); setActiveTab("Template"); setFileName("Template")}}
              />
            </>
          ...
          {!isViewOnly() && (
            <>
              ...
              <Button
                classes="w-30"
                name="Upload"
                onClick={() => {setSelectFile(true); setActiveTab("planDetails");setFileName("Planning Details")}}
              />
            </>
        ...
        {!isViewOnly() && (
          <>
            ...
            <Button
              classes="w-30"
              name="Upload"
              onClick={() => {setSelectFile(true); setActiveTab("siteDetails"); setFileName("Site Details")}}
            />
        ...
        {!isViewOnly() && (
          <>
            ...
            <Button
              classes="w-30"
              name="Upload"
              onClick={() => {setSelectFile(true); setActiveTab("ranChecklist"); setFileName("Checklist")}}
            />
        ...
        {!isViewOnly() && (
          <>
            ...
            <Button
              classes="w-30"
              name="Upload"
              onClick={() => {setSelectFile(true); setActiveTab("acceptanceLog"); setFileName("Acceptance Log")}}
            />
          </>
        )}
        </div>
  ...
  const onTableViewSubmit = (data) => {
      dispatch(CommonActions.fileSubmit("/Compliance/templateUpload/"+`${siteuid}/${milestoneName}/${activeTab}/${rowId}`,data,() => {
          setSelectFile(false);
          setActiveTab(null);
        }
      )
    ...
    <>
      ...
      <div className="relative overflow-scroll h-[94vh] p-4">
        ...
        <FileUploader
          ...
          tempbtn={true}
          label={"Template"}
          tempbtnlink={[`${"/getOneCompliance/templateExport/"}${siteuid}/${milestoneName}/${activeTab}`, `${fileName}.xlsx`]}
        />
