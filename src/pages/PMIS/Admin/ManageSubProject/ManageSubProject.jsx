...
const ManageSubProject = () => {
        ...
        return interdata?.map((itm) => {
            let updateditm = {
                ...
                "milestone": <CstmButton className={"p-2"} child={<Button classes='w- 10' name={""} icon={<Unicons.UilAirplay />} onClick={() => {
                    ...
                    setmodalBody(<>
                        <ManageSubProjectForm isOpen={modalOpen} setIsOpen={setmodalOpen} resetting={false} formValue={itm} />
                        {/* <div className='mx-3'><Button name={"Submit"} classes={""} onClick={(handleSubmit(onTableViewSubmit))} /></div> */}
                    </>)
                }}></Button>} />,
                    ...
                    let msgdata = {
                        ...
                        buttons: [
                            <Button classes='w-15 bg-green-500' onClick={() => {
                                dispatch(CommonActions.deleteApiCaller(`${Urls.admin_sub_projecttype}/${projecttypeuniqueId}/${itm.uniqueId}`, () => {
    ...
    return type ?
        ...
        : <>
            ...
            } settype={settype} label='Add / Modify Project Type' showbtn={false} />
