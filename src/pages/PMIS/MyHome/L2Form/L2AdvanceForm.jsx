...
const L2AdvanceForm = () => {
        ...
        return interdata?.map((itm) => {
            let updateditm = {
                ...
                "edit": <CstmButton className={"p-2"} child={<EditButton name={""} onClick={() => {
                    ...
                    setmodalBody(<>
                        <L2AdvanceFormFORM isOpen={modalOpen} setIsOpen={setmodalOpen} resetting={false} formValue={itm} />
                    ...
                    let msgdata = {
                        ...
                        buttons: [
                            <Button classes='w-15 bg-green-500' onClick={() => {
                                dispatch(CommonActions.deleteApiCaller(`${Urls.expAdv_L2AdvanceData}/${itm.uniqueId}`, () => {
                                    dispatch(ExpenseAdvanceActions.getL2AdvanceData())
    ...
    const onSubmit = (data) => {
        ...
        delete data.reseter
        dispatch(ExpenseAdvanceActions.getL2AdvanceData(value, objectToQueryString(data)))
    }
