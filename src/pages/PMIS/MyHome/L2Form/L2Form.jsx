...
import L2FormFORM from './L2FormFORM';
        ...
        return interdata?.map((itm) => {
            let updateditm = {
                ...
                "edit": <CstmButton className={"p-2"} child={<EditButton name={""} onClick={() => {
                    ...
                    setmodalBody(<>
                        <L2FormFORM isOpen={modalOpen} setIsOpen={setmodalOpen} resetting={false} formValue={itm} />
                    ...
                    let msgdata = {
                        ...
                        buttons: [
                            <Button classes='w-15 bg-green-500' onClick={() => {
                                dispatch(CommonActions.deleteApiCaller(`${Urls.expAdv_L2Data}/${itm.uniqueId}`, () => {
                                    dispatch(ExpenseAdvanceActions.getL2Data())
