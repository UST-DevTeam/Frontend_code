...
const L1AdvanceForm = () => {
                        ...
                        onClick={() => {
                          dispatch(
                            CommonActions.deleteApiCaller(
                              `${Urls.expAdv_L1AdvanceData}/${itm.uniqueId}`,
                              () => {
                                dispatch(
                                  ExpenseAdvanceActions.getL1AdvanceData()
                                );
  ...
  let table = {
    columns: [
      ...
      },
      {
        ...
        value: "AdvanceNo",
        style:
          "min-w-[170px] max-w-[450px] text-center sticky left-[39px] bg-[#3e454d]",
      },
      {
        name: "Advance Date",
        value: "CreatedAt",
      ...
      //   },
      {
        ...
        value: "Amount",
        style:
          "min-w-[170px] max-w-[450px] text-center sticky left-[169px] bg-[#3e454d]",
      },
      {
        name: "Current Status",
        value: "customStatus",
    ...
    selectRows.forEach((key) => {
      ...
      if (item) {
        amountRemark.push({
          ...
          addedFor:
            key in amount.addedFor ? amount.addedFor[key] : item.addedFor,
          AdvanceNo:
            key in amount.AdvanceNo ? amount.AdvanceNo[key] : item.AdvanceNo,
        });
      }
    });
  ...
  const onSubmit = (data) => {
    console.log("fghjklkjhggkl", data);
    let value = data.reseter;
    delete data.reseter;
    dispatch(
      ExpenseAdvanceActions.getL1AdvanceData(value, objectToQueryString(data))
    );
  };
        ...
        headerButton={
          <div className="flex gap-1">
            ...
            <div className="flex gap-1">
              ...
              classes="w-auto"
              onClick={(e) => {
                dispatch(CommonActions.commondownload("/export/Advance/l1Approval","Export__Advance_L1Aprroval.xlsx"))
              }}
              name={"Export"}
            ></Button>
            </div>
