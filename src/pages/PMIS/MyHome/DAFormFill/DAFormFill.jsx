                    ...
                    let msgdata = {
                        ...
                        buttons: [
                            <Button classes='w-15 bg-green-500' onClick={() => {
                                dispatch(CommonActions.deleteApiCaller(`${Urls.expAdv_DA_Fill}/${itm.uniqueId}`, () => {
                                    dispatch(ExpenseAdvanceActions.getDAFill())
    ...
    return <>
        <AdvancedTable
            headerButton={<div className='flex gap-1'>
                <Button classes="mr-1" onClick={(e) => {
                setmodalOpen((prev) => !prev);
                setmodalHead("Add DA");
                setmodalBody(
                <DAFormFillFORM isOpen={modalOpen} setIsOpen={setmodalOpen} resetting={true} formValue={{}}/> );
              }}
              name={"Add DA"}
            ></Button>
