  ...
  return (
    <>
      <Multiselect
        ...
        className="pt-1 text-black bg-white border-black border block  h-20 rounded-md py-1.5 p-2 text-white-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
      />
    </>
  );
};
