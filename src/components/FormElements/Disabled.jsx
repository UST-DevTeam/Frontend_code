...
const Disabled = ({ itm,errors, handleSubmit, setValue, getValues, register}) => {
    ...
    let classes={
        "sdisabled":"bg-slate-300 font-bold border-black border block h-8 w-full rounded-md py-1.5 p-2 text-gray-700 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6",
