                      ...
                      <>
                        {[""].includes(itts.name) ? (
                          ["Edit"].includes(itts.name) ? (
                            <td
                              colSpan={2}
                              className={`border-primaryLine h-14  border-[1.5px] bg-primaryLine min-w-[200px] max-w-[200px] text-center`}
                            >
                    ...
                    return (
                      <tr>
                        {table.columns.map((innerItm, index) => {
                          return hide.indexOf(String(index)) == -1 ? (
                            <td
                              className={`text-[11px] h-7 pl-1 border-primaryLine border-[0.5px] overflow-hidden text-gray-900 ${
                                innerItm.style
                                  ? innerItm.style
                                  : " min-w-[300px] max-w-[500px]"
                              }`}
