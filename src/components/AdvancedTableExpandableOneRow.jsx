      ...
      {expand &&
        ...
        Object.entries(table.childs)?.map((onewq) => {
          return itm[onewq[0]]?.map((onewqq) => {
            ...
            return (
              <tr>
                <td className="text-[12px] pl-1 border-[#0e8670] border-[0.1px] bg-[#3e454d] text-primaryLine ">
                  {multiSelect ? (
                ...
                {table?.childs[onewq[0]]?.map((itts) => {
                  ...
                  return (
                    <td
                      className={`text-[12px] pl-1 cursor-pointer border-[#0e8670] border-[0.1px] bg- text-white ${
