              ...
              <div className="w-full">
                <div style={{ width: "100px" }}>
                  <Multiselect
                    ...
                    className='pt-1 text-black bg-white border-black border block h-8 w-24 rounded-md py-1.5 p-2 text-white-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6'
                  /></div></div>) : (
              <></>
            )}
