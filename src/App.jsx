    ...
    return (
        <main className='flex h-screen overflow-hidden  justify-center'>
            ...
            </Routes>
            {
                ...
                !locdata.pathname.includes("/login") && !locdata.pathname.includes("/register") && !locdata.pathname.includes("/setupPassword") && !locdata.pathname.includes("/agreement") && !locdata.pathname.includes("/kycregister") && !locdata.pathname.includes("/otp") && !locdata.pathname.includes("/viewPitch") && !locdata.pathname.includes("/companydetail") && !locdata.pathname.includes("/businessRegistration") && !locdata.pathname.includes("/setupRegistration") ?
